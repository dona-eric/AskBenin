    ...
    extend: {
      ...
      keyframes: {
        ...
        glowPulse: {
          ...
          '50%': { boxShadow: '0 0 24px rgba(212, 160, 23, 0.6)' },
        },
        bounceSubtle: {
      ...
      backgroundImage: {
        ...
        'gradient-hero': 'linear-gradient(135deg, #080d19 0%, #0f172a 40%, #172033 100%)',
        'gradient-gold': 'linear-gradient(135deg, #D4A017 0%, #facc15 100%)',
        'gradient-green': 'linear-gradient(135deg, #065f46 0%, #10b981 100%)',
        'gradient-cta': 'linear-gradient(135deg, #064e3b 0%, #047857 50%, #D4A017 100%)',
        'glass-border': 'linear-gradient(135deg, rgba(212,160,23,0.3), rgba(16,185,129,0.1))',
      },
      boxShadow: {
